...
export const TypewriterEffect = ({
  ...
  return (
    <div
      className={cn(
        'text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-[7.5rem] 2xl:text-[10rem] font-bold tracking-tight',
        className
      )}
    >
      {renderWords()}
...
export const TypewriterEffectSmooth = ({
  ...
  return (
    <div className={cn('flex space-x-1 my-2 md:my-4', className)}>
      <motion.div
